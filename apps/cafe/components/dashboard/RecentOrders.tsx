        ...
        {loading ? (
          ...
          <ul className="divide-y">
            {rows.map((order) => {
              ...
              // KPIs above this list exclude it — so showing the row as an ordinary
              // sale would make the dashboard contradict itself. Mark it and strike
              // the amount instead of hiding the row (the trail stays visible).
                ...
                <li key={order._id}>
                  ...
                  >
                    ...
                    <Badge
                      ...
                      className={cn(
                        "shrink-0",
                        cancelled ? "text-gray-600" : payStyle?.color,
                      )}
                    >
